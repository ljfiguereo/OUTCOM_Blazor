...
{
    /// <inheritdoc />
    public partial class AddUserRolesAndAuditSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 8, 21, 21, 31, 44, 367, DateTimeKind.Utc).AddTicks(2586), "Acceso completo al sistema con permisos administrativos", "Administrador", 1 },
                    { 2, new DateTime(2025, 8, 21, 21, 31, 44, 367, DateTimeKind.Utc).AddTicks(2589), "Usuario estándar con acceso a funcionalidades básicas", "Cliente", 0 }
                });
